...
export function getInstallStatus() {
  ...
  try {
    const prootBypassPath = path.join(PROOT_ROOTFS, 'ubuntu', 'root', '.openclawd', 'bionic-bypass.js');
...
`;
  ...
  const prootBypassPath = path.join(PROOT_UBUNTU_ROOT, '.openclawd', 'bionic-bypass.js');
